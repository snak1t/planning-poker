...
const addUserToStoreAction = ifElse(user => user.error, ({ error }) => setErrorMessage(error), addUserToStore);
...
export const fetchUser = getFetch('/api/user', ifElse(user => !user.login, removeUserFromStore, addUserToStore), {});
